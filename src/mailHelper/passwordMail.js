...
export const sendForgotPasswordEmail = ({ user, url }) => {
  const emailBody = {
    from: '"Praveen Niroula 👻" <praveen@example.com>', // sender address
    to: user.email, // list of receivers
    subject: `Hello ${user.fName}✔`, // Subject line
    text: `Hello ${user.fName}✔. Please folow link to reset your password ${url}`, // plain text body
    html: `Hello ${user.fName}✔. Please folow link to reset your password <a href=${url}>Click Me</a> `, // html body
  };
